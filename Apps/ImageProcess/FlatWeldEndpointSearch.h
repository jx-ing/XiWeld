...
{
class FlatWeldEndpointSearch : public GenericImage
{
public:
	FlatWeldEndpointSearch();
	virtual ~FlatWeldEndpointSearch();
...
private:
	...
	/// @brief 激光跟踪配置文件名称
	CString m_sLaserTrackConfigName = _T("WidgetLaserTrack");

	/// @brief 提取激光点配置文件名称
	CString m_sLaserPntConfigName = _T("WidgetLaserPntExt");
