...
public:
	...
	// 开启跟踪
	void openTrack(CRobotDriverAdaptor* pRobotDriver, int nCurMovePntNo, bool bIsTracking, int& nNextOpenTrackStep);
	...
	bool CheckPreconditions(CRobotDriverAdaptor* pRobotDriver);

	bool IniWeldResources(CRobotDriverAdaptor* pRobotDriver, CString strCoutPath, FILE*& RecordRealData);
