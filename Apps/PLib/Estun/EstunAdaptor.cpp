...
bool EstunAdaptor::EstunTrackInit( const T_ROBOT_COORS& startPos,double dTrackCurrent, double dTrackVoltage, const CString& IP,  double Speed, const vector<int>& Cfg)
{
	ESString myIp(IP);
...
bool EstunAdaptor::SendWeldTriangleWeaveProgramRobot(int nWeldTrackNum, E_WELD_SEAM_TYPE eWeldSeamType)
{
	CString sWelderMode_W;		//焊接模式参数W
	CString sWelderMode_MM;		//焊接模式参数MM
	if (!getWelderMode(eWeldSeamType, sWelderMode_W, sWelderMode_MM))
